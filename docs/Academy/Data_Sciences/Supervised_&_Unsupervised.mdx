...
sidebar_position: 2
---
# Techniques Supervisé vs Non Supervisé
...
<div className="pmargin">
  <div className="indentp">
    ...
    | ClientID | Superficie en m²   <br /> X<sub>1</sub> | Nbre de chambres  <br /> X<sub>2</sub> | Consommation énergétique <br /> X<sub>3</sub> | Nbre de salles de bain <br /> X<sub>4</sub> | Prix <br /><br /> Y |
    |:---------------------:|:----------:|:---------------------:|:---------------------:|:---------------------:|:------------------------:|
